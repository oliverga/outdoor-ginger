    ...
    <main className="">
      <Hero title="About August" imageSrc="/aboutMe.png">
        <div id="left" className="md:mt-2 w-full mb-8">
          <p className="text-ogLabel-faint font-extralight md:text-2xl italic w-max">
        ...
        <div className="flex flex-col md:grid grid-cols-3 grid-rows-1">
          ...
          <div className="md:col-span-2 flex md:self-center md:justify-end">
            <Image
              ...
              width={1000}
              height={1000}
              className="mt-4 self-center md:w-auto"
            />
          </div>
        </div>
      </section>
      <OrangeBanner h2="Beyond boundaries">
        <div className="flex flex-col items-center">
          ...
          <p className="text-ogBG-base font-normal leading-5 text-sm md:text-xl md:w-2/3">
            ...
            he&apos;s reached&apos; it&apos;s about the lessons learned along
            the way. Through the trials and triumphs of life on the road,
            het&apos;s discovered a profound sense of self-reliance and
            resilience, forging a path that defies convention and embraces the
            unknown.
          </p>
        </div>
      </OrangeBanner>
      <div className="relative -top-36 md:-top-60">
        <div className="flex justify-center">
          <Image
            ...
            width={1000}
            height={1000}
            className="w-80 md:w-1/3 rounded-full"
          />
        </div>
      </div>
        ...
        <div className="md:grid grid-cols-3 grid-rows-1">
          <div className="col-span-1 flex flex-col pb-4">
            ...
            <div className="self-center">
              <p className="mb-6">
                August&apos;s story isn&apos;t just about the destinations
                he&apos;s reached; it&apos;s about the lessons learned along the
                way. Through the trials and triumphs of life on the road,
                he&apos;s discovered a profound sense of self-reliance and
                resilience, forging a path that defies convention and embraces
                the unknown.
              </p>
          ...
          <div className="md:col-span-2 flex md:justify-end">
            <Image
              ...
              width={1000}
              height={1000}
              className="mt-8 md:w-96 rounded-full"
            />
          </div>
        </div>
      </div>
      ...
      <section className="px-6 md:px-0 max-w-5xl mx-auto my-10 md:my-24">
        ...
        {testimonials.map((testimonial, index) => (
          <div
            className="prose md:prose-lg prose-h3:italic prose-p:italic prose-p:text-ogLabel-muted w-auto prose-h3:font-light prose-p:font-light prose-p:text-sm prose-h3:text-sm my-4"
            key={index}
          >
