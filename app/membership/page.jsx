	...
	return (
		<main className="relative">
			<Hero title="Membership" imageSrc="/membershiphero.webp" height="60vh">
				<div
					id="right"
					className="mt-72 md:mt-0 w-dvw md:left-auto px-6 md:top-1/3 md:px-0 md:w-80 absolute left-1/2 transform -translate-x-1/2"
				>
					<Card className="rounded-2xl">
						...
						<CardFooter className="flex justify-between">
							<p className="text-3xl font-semibold">
								50 kr{" "}
								<span className="text-sm font-light text-ogLabel-muted ">
									/ Month{" "}
								</span>
							</p>
							<Button
								size="default"
								className="bg-ogPrimary hover:bg-ogPrimary-dark text-base"
							>
								Subscribe
							</Button>
						</CardFooter>
