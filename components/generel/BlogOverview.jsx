...
export default function BlogOverview({ posts }) {
  ...
  return (
    <div className="pb-32 max-w-5xl mx-auto px-8 md:-mt-[500px] pointer-events-auto">
      <div className="h-28 bg-gradient-to-b from-transparent to-ogBG-base hidden md:block relative pointer-events-none z-60 " />
      <section className="md:relative md:z-60 pointer-events-auto">
