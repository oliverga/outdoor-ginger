...
function Hero({ title, imageSrc, height, children, bgPos }) {
  return (
    <section className="relative mb-12 ">
      <div style={{ height: height }} className="overflow-hidden grid grid-cols-2 max-w-5xl mx-auto pb-24 px-8">
      ...
      <Image src={imageSrc} alt="" width={1920} height={1000} className="object-cover object-center w-full h-full absolute top-0 left-0 z-10" style={{ objectPosition: bgPos }} />
    </section>
  );
}
