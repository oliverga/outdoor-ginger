  ...
  return (
    <div className="my-10 py-10 md:my-32">
      <section className="px-6 md:px-0 max-w-7xl mx-auto">
        <div className="">
          <h2 className="font-display text-3xl md:text-6xl text-center font-bold uppercase pb-2 md:pb-10">Frequently Asked Questions</h2>
          <h3 className="font-display text-xl leading-5 md:text-3xl text-center font-bold uppercase pb-6 md:pb-10">Outdoor Ginger Membership</h3>
          <div className="flex flex-col items-center justify-center px-6 md:px-0">
            <Accordion type="single" collapsible className="md:w-1/2 ">
              <AccordionItem value="item-1" defaultOpen={true}>
                <AccordionTrigger className="text-base md:text-xl">{"What do I get as an Outdoor Ginger member?"}</AccordionTrigger>
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-base md:text-xl">{"How often is new content added for members?"}</AccordionTrigger>
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger className="text-base md:text-xl">How can I participate in the live Q&A sessions?</AccordionTrigger>
              ...
              <AccordionItem value="item-4">
                <AccordionTrigger className="text-base md:text-xl">What type of exclusive adventure guides will I receive?</AccordionTrigger>
                <AccordionContent className="text-ogLabel-muted text-sm md:text-lg">
              ...
              <AccordionItem value="item-5">
                <AccordionTrigger className="text-base md:text-xl">Is there a community where I can interact with other members?</AccordionTrigger>
              ...
              <AccordionItem value="item-6">
                <AccordionTrigger className="text-base md:text-xl">How can I access the special discounts on merchandise?</AccordionTrigger>
                <AccordionContent className="text-ogLabel-muted text-sm md:text-lg">
              ...
              <AccordionItem value="item-7">
                <AccordionTrigger className="text-base md:text-xl">Can I cancel my membership at any time?</AccordionTrigger>
                <AccordionContent className="text-ogLabel-muted text-sm md:text-lg">
              ...
              <AccordionItem value="item-8">
                <AccordionTrigger className="text-base md:text-xl">What payment methods are accepted for the membership?</AccordionTrigger>
